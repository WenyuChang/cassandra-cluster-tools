...
@Command(name = "enablehintedhandoff", description = "Esable storing hinted handoffs")
public class EnableHintedHandoff extends ClusterToolCmd
{
    ...
    private class Executor extends AsyncTask<String> {
        ...
        public String execute() {
            ...
            return "Hinted handoff is enabled on " + OutTextStyle.ANSI_RED + node.server + OutTextStyle.ANSI_RESET;
        }
    }
}