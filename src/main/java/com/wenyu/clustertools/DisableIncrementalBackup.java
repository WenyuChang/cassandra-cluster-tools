...
@Command(name = "disableincrementalbackup", description = "Disable incremental backup")
public class DisableIncrementalBackup extends ClusterToolCmd
{
    ...
    private class Executor extends AsyncTask<String> {
        ...
        public String execute() {
            ...
            return "Incremental backup is disabled on " + OutTextStyle.ANSI_RED + node.server + OutTextStyle.ANSI_RESET;
        }
    }
}