...
@Command(name = "pausehintedhandoff", description = "Pause hints delivery process")
public class PauseHintedHandoff extends ClusterToolCmd
{
    ...
    private class Executor extends AsyncTask<String> {
        ...
        public String execute() {
            ...
            return "Hinted handoff is paused on " + OutTextStyle.ANSI_RED + node.server + OutTextStyle.ANSI_RESET;
        }
    }
}