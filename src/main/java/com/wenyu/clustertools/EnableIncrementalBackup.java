...
@Command(name = "enableincrementalbackup", description = "Enable incremental backup")
public class EnableIncrementalBackup extends ClusterToolCmd
{
    ...
    private class Executor extends AsyncTask<String> {
        ...
        public String execute() {
            ...
            return "Incremental backup is enabled on " + OutTextStyle.ANSI_RED + node.server + OutTextStyle.ANSI_RESET;
        }
    }
}