...
@Command(name = "disablehintedhandoff", description = "Disable storing hinted handoffs")
public class DisableHintedHandoff extends ClusterToolCmd
{
    ...
    private class Executor extends AsyncTask<String> {
        ...
        public String execute() {
            ...
            return "Hinted handoff is disabled on " + OutTextStyle.ANSI_RED + node.server + OutTextStyle.ANSI_RESET;
        }
    }
}